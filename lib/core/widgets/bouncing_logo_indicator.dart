...
//             decoration: const BoxDecoration(
//               shape: BoxShape.circle,
//               color: Colors.grey, // Outer circle background color
//             ),
//           ),
//           SlideTransition(
//             position: _bounceAnimation,
//             child: Center(
//               child: Container(
//                 width: 25, // Slightly larger size for visibility
//                 height: 25,
//                 decoration: BoxDecoration(
//                   shape: BoxShape.circle,
//                   color: Colors.blue
//                       .withOpacity(1), // Light background for visibility
//                 ),
//                 child: SvgPicture.asset(
//                   widget.logo,
//                   fit: BoxFit.contain,
//                   color: Colors.blue, // Optional color to see if it appears
//                 ),
//               ),
//             ),
//           ),
