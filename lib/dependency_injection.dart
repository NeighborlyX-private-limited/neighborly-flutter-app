...
void init() async {
  ...
  sl.registerFactory(() => GoogleAuthenticationBloc(googleAuthenticationaUsecase: sl()));
  ...
  sl.registerFactory(() => GetCommentsByPostIdBloc(getCommentsByPostIdUsecase: sl()));
  ...
  sl.registerFactory(() => FetchCommentReplyBloc(fetchCommentReplyUsecase: sl()));
  ...
  sl.registerFactory(() => CommunityDetailsCubit(sl(), sl(), sl(), sl(), sl(), sl(), sl(), sl(), sl(), sl(), sl(), sl(), sl(), sl()));
