...
class NotificationModel extends NotificationEntity {
  ...
  @override
  String toString() {
    return 'NotificationModel(id: $id, triggerType: $triggerType, title: $title, message: $message, postId: $postId, eventId: $eventId, messageId: $messageId, commentId: $commentId, groupId: $groupId, notificationImage: $notificationImage, userId: $userId, userName: $userName, timestamp: $timestamp, status: $status, posttype: $posttype, icon: $icon)';
  }
