...
class PostReactionSpecificCommentWidget extends StatefulWidget {
  ...
  const PostReactionSpecificCommentWidget({
    super.key,
  ...
  @override
  State<PostReactionSpecificCommentWidget> createState() =>
      _PostReactionSpecificCommentWidgetState();
}

class _PostReactionSpecificCommentWidgetState
    extends State<PostReactionSpecificCommentWidget> {
