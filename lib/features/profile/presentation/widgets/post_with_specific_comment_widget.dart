...
class PostWithSpecificCommentsWidget extends StatefulWidget {
  ...
  const PostWithSpecificCommentsWidget({
    super.key,
    required this.post,
  });

  @override
  State<PostWithSpecificCommentsWidget> createState() =>
      _PostWithCommentsWidgetState();
}

class _PostWithCommentsWidgetState
    extends State<PostWithSpecificCommentsWidget> {
                ...
                children: [
                  ClipOval(
                    child: Container(
                        ...
                        child: Image.network(
                          widget.post.content.proPic.toString(),
                          fit: BoxFit.contain,
                        )),
                  ),
                  const SizedBox(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      PostReactionSpecificCommentWidget(
